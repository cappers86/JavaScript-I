...
console.log(`car ${inventory[32].id}.id is a ${inventory[32].car_year} ${inventory[32].car_make} ${inventory[32].car_model}`);
...
console.log("These are teh avaible BMW and Audi cars on the lot:" + JSON.stringify(BMWAndAudi));